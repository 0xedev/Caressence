      ...
      <div className="col hero-inner">
        ...
        <div style={{ marginTop: 22 }}>
          ...
          <div className="cta-note">
            <span>Starting from ₦9,800</span>
            <span>21-days guarantee</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="story tight" data-screen-label="Story">
      <div className="col">
        ...
        <div className="pullquote">
          ...
          <span className="min">&mdash; Esther A.O, Abuja</span>
        </div>
      </div>
    </section>
  );
...
const REVIEWS_TOP = [
  ...
  { num: 2, name: "Juwon", quote: "Not sticky. Absorbs fast. I cream every morning now.", duration: "0:52", tone: "sage", video: "videos/review-3.mp4", poster: "videos/review-3-poster.jpg" },
  { num: 3, name: "Josephine", quote: "After the shower, the burn-itch is gone. Honestly worth it.", duration: "0:44", tone: "deep", video: "videos/review-2.mp4", poster: "videos/review-2-poster.jpg" },
];
      ...
      <div className="col">
        ...
        <div className="size-card">
          ...
          <div className="body">
            ...
            <div className="perml">Only 30 bottles left</div>
        ...
        <div className="size-card featured">
          ...
          <div className="body">
            ...
            <div className="perml">Only 7 bottles left</div>
            <div style={{ marginTop: 12 }}>
